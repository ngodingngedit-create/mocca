      ...
      <div class="products-grid" :class="{ 'empty-grid': filteredProducts.length === 0 }">
        ...
        <div v-for="product in filteredProducts" :key="product.id" class="product-card" @click="handleCardClick(product, $event)">
          ...
          <div class="product-info">
            ...
            <!-- Color Swatches Row (underneath price, aligned to the left) -->
            <div class="color-swatches-row">
              <div class="color-swatches">
                <span 
                  ...
                  @click="selectedColors[product.id] = color"
                  :title="color"
                ></span>
              </div>
            </div>
    ...
    <div class="collections-container">
      <div class="collections-layout">
        ...
        <div class="collections-grid">
          ...
          <div class="collection-thumbnail-card">
            <div class="thumbnail-image-wrapper">
              <img src="/mocca_col_accessories.png" alt="Mocca Accessories Curated Flat Lay" class="thumbnail-image" />
            </div>
